...
def common(s, plus, times1, times2, plus_unit, times_unit):
    ...
    for i in range(n + 1):  # N.B.: n+1: tot[n, n] = 1
    ...
    for span in range(2, n + 1):  # span length: 2..n
        for i in range(n - span + 1):  # left boundary: 0..(n-span)
            ...
            for k in range(i + 1, j + 1):  # case 2: i paird with some k-1
...
tmp = [
(139.35999999999999, 'UUUGUUCCGGCAA'),
(139.35999999999999, 'GGGUGGAAUUACC'),
(139.35999999999999, 'AAACAAGGCCGUU'),
(139.35999999999999, 'AAAGAACCGGCUU'),
(139.35999999999999, 'UUUGUUCCGGCAA'),
(139.35999999999999, 'UUUCUUGGCCGAA'),
(139.35999999999999, 'GGGAGGUUAAUCC'),
(139.35999999999999, 'CCCUCCAAUUAGG'),
(139.35999999999999, 'CCCACCUUAAUGG'),
]

for _, seq in tmp:
    print(kbest(seq, 3))

# print(kbest("UGCUACCAGGA", 10))
# print(kbest("AAUCGGACUCU", 10))
print(kbest("UUAGCCCAGGA", 3))


# print(kbest("ACGUGC", 10))
# print(kbest("UUAAGC", 10))
# print(kbest('UAGAGGCGCCCAU', 3))
# print(kbest('UAGGC', 10))

# print(kbest("GCGAUGAUUCC", 20))
# print(kbest("GCUA", 20))
# print(kbest("AAUAUAACUUU", 100))